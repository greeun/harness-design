...
- **UI/UX optimized** — Planner outputs design tokens, information architecture, responsive strategy, and accessibility requirements
...
- **Direction-change control** — Generator can't pivot design without Evaluator's explicit `REDIRECT`
- **V1/V2 modes** — Full sprint loop (Sonnet) or simplified single-pass (Opus)
